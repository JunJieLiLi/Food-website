 ...
 */
define("HOST", "mysql.cs.mun.ca"); 			// The host you want to connect to. 
define("USER", "cs3715_bz1134"); 			// The database username. 
define("PASSWORD", "bluegreen09"); 	// The database password. 
define("DATABASE", "cs3715_bz1134");             // The database name.
